/**
 * This code snippet is a functional component in React that implements a user registration form.
 * It uses the `useFormik` hook from the Formik library to handle form state and validation.
 * The form schema is defined using Yup for validation.
 * The component dispatches a Redux action to register the user when the form is submitted.
 * It also uses React Router's `useNavigate` hook to redirect the user to the login page after successful registration.
 *
 * Example Usage:
 ...
 *
 * Flow:
 * 1. The component imports necessary dependencies and defines the form schema using Yup.
 * 2. It initializes the `dispatch` and `navigate` variables using the `useDispatch` and `useNavigate` hooks.
 * 3. The `useFormik` hook is used to initialize the form state and validation.
 * 4. The component selects the relevant state from the Redux store using the `useSelector` hook.
 * 5. If the user is already registered, the component redirects to the login page.
 * 6. The component renders the registration form using JSX.
 * 7. When the form is submitted, the `onSubmit` function is called, which dispatches the `registerUserAction` with the form values.
 * 8. The form displays error messages if there are any validation errors or server errors.
 *
 * Outputs:
 * - The component renders a registration form with input fields for first name, last name, email, and password.
 * - If the user is already registered, the component redirects to the login page.
 * - The form displays error messages if there are any validation errors or server errors.
 */
        ...
        <div className='max-w-5xl mx-auto'>
          <div className='flex flex-wrap items-center -mx-4'>
            ...
            <div className='w-full lg:w-1/2 px-4'>
              <div className='px-6 lg:px-20 py-12 lg:py-24 backdrop-blur-lg shadow-lg rounded-lg'>
