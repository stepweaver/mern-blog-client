            ...
            <div className='flex justify-between h-16'>
              ...
              <div className='flex items-center'>
                <div className='flex-shrink-0 '>
                  <Link
                    to='/create-post'
                    className='pr-3  relative inline-flex items-center mr-2 px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500'
                  >
                    <PlusIcon
